...
def build_hime_repository() -> FakeRepository:
    ...
    repo.setup_search_result(
        ...
        [
            "chimera [anitube]",
            "himegoto [animesdigital, sushianimes, anitube]",
            "arete hime [anitube]",
            "koihime musou [sushianimes]",
            "mushikaburi hime [animefire, sushianimes]",
            "chou kaguya hime [animefire, anitube]",
            "kyuuketsuhime miyu [animefire]",
            "shikabane hime aka [animesdigital, sushianimes]",
            "hanyou no yashahime [anitube]",
            "shikabane hime kuro [animesdigital]",
            "tensui no sakuna hime [animefire, animesdigital, sushianimes, anitube]",
            "koihimemusou ova omake [animefire]",
            "niehime to kemono no ou [animefire, animesdigital, sushianimes]",
            "ryuu to sobakasu no hime [animefire]",
            "akagami no shirayuki hime [animesdigital, sushianimes, anitube]",
            "choushin hime dangaizer 3 [anitube]",
            "andersen douwa ningyohime [anitube]",
            "kuragehime eiyuu retsuden [animefire]",
            "akagami no shirayuki hime 2 [animesdigital]",
            "hanyou no yashahime dublado [anitube]",
            "T1",
            "T2",
            "T3",
            "T4",
