...
class TestSushiAnimesScraper:
    ...
    @patch("scrapers.plugins.sushianimes.fetch")
    ...
    def test_search_episodes_swallows_http_errors(self, mock_get, mock_rep):
        mock_get.side_effect = FetchError("403 Client Error")
